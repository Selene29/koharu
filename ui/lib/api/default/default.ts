...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetGoogleFontFileQueryKey(family,file);
   ...
   return  { queryKey, queryFn, enabled: !!(family && file),  gcTime: 300000, retry: 1,  ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getGoogleFontFile>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
const {mutation: mutationOptions, request: requestOptions} = options ?
 ...
 , queryClient?: QueryClient): UseMutationResult<
    ...
    export const getDeleteLocalLlmModelUrl = (params: DeleteLocalLlmModelParams,) => {
...
export const deleteLocalLlmModel = async (params: DeleteLocalLlmModelParams, options?: RequestInit): Promise<void> => {

  return fetchApi<void>(getDeleteLocalLlmModelUrl(params),
  {
    ...options,
    method: 'DELETE'
...
export const getDeleteLocalLlmModelMutationOptions = <TError = ApiError,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteLocalLlmModel>>, TError,{params: DeleteLocalLlmModelParams}, TContext>, request?: SecondParameter<typeof fetchApi>}
): UseMutationOptions<Awaited<ReturnType<typeof deleteLocalLlmModel>>, TError,{params: DeleteLocalLlmModelParams}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof deleteLocalLlmModel>>, {params: DeleteLocalLlmModelParams}> = (props) => {
          const {params} = props ?? {};

          return  deleteLocalLlmModel(params,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type DeleteLocalLlmModelMutationResult = NonNullable<Awaited<ReturnType<typeof deleteLocalLlmModel>>>

    export type DeleteLocalLlmModelMutationError = ApiError

    export const useDeleteLocalLlmModel = <TError = ApiError,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteLocalLlmModel>>, TError,{params: DeleteLocalLlmModelParams}, TContext>, request?: SecondParameter<typeof fetchApi>}
 , queryClient?: QueryClient): UseMutationResult<
        Awaited<ReturnType<typeof deleteLocalLlmModel>>,
        TError,
        {params: DeleteLocalLlmModelParams},
        TContext
      > => {
...
export const useCreatePagesFromPaths = <TError = unknown,
 ...
 , queryClient?: QueryClient): UseMutationResult<
    ...
    export const getPatchPageUrl = (id: PageId,) => {
...
export const patchPage = async (id: PageId,
    pagePatch: PagePatch, options?: RequestInit): Promise<void> => {

  return fetchApi<void>(getPatchPageUrl(id),
  {
    ...options,
    method: 'PATCH',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getPatchPageMutationOptions = <TError = unknown,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof patchPage>>, TError,{id: PageId;data: PagePatch}, TContext>, request?: SecondParameter<typeof fetchApi>}
): UseMutationOptions<Awaited<ReturnType<typeof patchPage>>, TError,{id: PageId;data: PagePatch}, TContext> => {

const mutationKey = ['patchPage'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof patchPage>>, {id: PageId;data: PagePatch}> = (props) => {
          const {id,data} = props ?? {};

          return  patchPage(id,data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type PatchPageMutationResult = NonNullable<Awaited<ReturnType<typeof patchPage>>>
    export type PatchPageMutationBody = PagePatch
    export type PatchPageMutationError = unknown

    export const usePatchPage = <TError = unknown,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof patchPage>>, TError,{id: PageId;data: PagePatch}, TContext>, request?: SecondParameter<typeof fetchApi>}
 , queryClient?: QueryClient): UseMutationResult<
        Awaited<ReturnType<typeof patchPage>>,
        TError,
        {id: PageId;data: PagePatch},
        TContext
      > => {
      return useMutation(getPatchPageMutationOptions(options), queryClient);
    }
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetPageThumbnailQueryKey(id);
   ...
   return  { queryKey, queryFn, enabled: !!(id),  gcTime: 300000, retry: 1,  ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getPageThumbnail>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
